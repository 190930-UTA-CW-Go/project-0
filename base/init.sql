...
insert into servicers values ('superd', 'SEC1verbose', 'Duda-Cola', 'D', 'Admin');
insert into servicers values ('supers', 'SEC2verbose', 'Salt-PhD',  'S', 'Admin');
insert into servicers values ('supert', 'SEC3verbose', 'TipsyCo',   'T', 'Admin');
